...
@SourceType(value = "SAPERPARP", label = "SAPERP",uiConfig = "saperp-layout.json")
public class SAPERPConf extends AbstractArpConf<SAPERPConf> {
  private static final String ARP_FILENAME = "arp/implementation/saperp-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.saperp.SAPERPDriver";
